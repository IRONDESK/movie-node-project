# movie-node-project
![Animation1](https://user-images.githubusercontent.com/87234410/153866046-1a82c38b-aa5f-4de0-9132-802bfa9f270d.gif)
## 개요
### 1.1 목적 및 소개
...
### 2.1 주요 기능
 ...
 2. 후기 작성과 수정 및 삭제 기능 구현 (CRUD)
 3. 넌적스 문법을 활용한 페이지 구현
 4. 네이버 영화 REST API로 기록에 해당하는 영화 정보 보여주기

### 2.2 기능 구현 스크린샷
#### 2.2.1 후기 작성
![Animation2](https://user-images.githubusercontent.com/87234410/153867824-227f6b73-a400-46ac-a94a-aed8a77741ff.gif)

#### 2.2.2 영화 검색
![Animation3](https://user-images.githubusercontent.com/87234410/153868050-6b7568c3-940b-4d5d-ab29-a9639bb27c86.gif)

## 제작 내용
### 3.1 제작 기간 및 역할
#### 3.1.1 제작 기간
1. 백엔드 개발 : 7일+ 소요
2. 프론트엔드 개발 : 1 ~ 2월 (약 5주)
